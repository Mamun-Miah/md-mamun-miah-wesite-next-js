        ...
        <div className="grid lg:grid-cols-12 gap-5">
          ...
          <div className="col-span-6 ms-2">
            <p className="para mb-8">
              I specialize in delivering top-tier SEO strategies and
              professional website development to help businesses thrive in the
              digital landscape. With a results-driven approach, I ensure that
              every project enhances your online presence, drives traffic, and
              maximizes growth.
            </p>
          </div>
        </div>
